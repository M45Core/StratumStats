...
if [[ "$capture_mode" == "mobile" ]]; then
  output_file="${1:-$repo_dir/docs/stratumstats-dashboard-mobile.png}"
  window_size="390,1520"
else
...
(cd "$repo_dir" && go build -o "$temporary_dir/stratumstats" .)
