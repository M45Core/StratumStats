...
func TestDashboardRendersExpandablePayoutAndMetricHistory(t *testing.T) {
	...
	for _, want := range []string{
		...
		"fee-change-list",
		"latency-chart-times\"><time datetime=\"" + now.Add(-time.Hour).Format(time.RFC3339) + "\" data-relative-time",
		"detail-meta\"><time datetime=\"" + now.Format(time.RFC3339) + "\" data-relative-time",
		"fee-change-list\">\n              \n              <li><time datetime=\"" + now.Format(time.RFC3339) + "\" data-relative-time",
		"1%",
